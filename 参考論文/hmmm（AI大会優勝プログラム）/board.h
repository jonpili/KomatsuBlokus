...
public:
    ...
    int x() { return m_ >>4 & 0xf; }
    int y() { return m_ & 0xf; }
    int piece_id() { return m_ >> 8; }
    int block_id() { return m_ >> 11; }
    int direction() { return m_ >> 8 & 0x7; }
    bool is_pass() { return m_ == 0xffff; }
    string fourcc();
...
protected:
    ...
    bool move_filter(int x, int y, const Piece *piece);
